...
namespace Me_has_visto.Models.Bussines
{
    ...
    { 
        public static void CreateThumbNail(
            ...
            bool maintainAspect)
        {
            //No hacer nada si l tamaño original es mas pequeño que 
            //el designado para la vista previa (thumbnail)
            ...
            try
            {
                ...
                if (maintainAspect)
                {
                    //Mantener el aspecto a pesar de los parametros
                    //de los parametros de tamaño de la vista previa
                    wi = thumbWi;
